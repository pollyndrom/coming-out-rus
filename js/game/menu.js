function Start(){
	...
	N("Привет. Я с радостью уделю тебе 20 минут.");
	N("Что тебя интересует?");
	...
	Choose({
		...
		"Хм, расскажи мне больше о игре. (Про игру)": function(){
...
function Play(message){
	...
	Choose({
		...
		"Видимо, ты никогда не завершишь игру... ": function(message){
            ...
            N("Разве не видишь, я работаю за ноутбуком,");
            N("Превращаю свою историю в эту игру.");
...
function Play_2(){
	...
	Choose({
		...
		"Эта 'правдивая' игра полна лжи?": function(message){
			...
			p(message);
			N("Даже если диалог был на 100% точным, это всё равно будет 100% ложь.");
			p(". . .");
			Play_3();
		}
	});
...
function Play_3(){
	...
	N("Ты будешь играть в роли меня, в 2010 году.");
	if(!$.asked_credits){
...
function Credits(message){
	...
	if($.asked_about){
		...
		N("Звуки и аудио взяты из разных свободных источников.");
	}else{
		N("Звуки и аудио, однако, взяты из разных свободных источников.");
	}

	N("И хотя, в основном только я сижу за своей игрой...");
	N("...за её историей стоит много людей.");
...
function About(message){
	...
	if($.asked_credits){
		...
		N("Игра...");
		N("...больше похожая на симулятор общения...");
