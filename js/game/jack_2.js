...
function What_Happened_Girl(message){
	...
	j("ЭУ в квадрате, они также подцепили к тебе репетитора?");
	n("Ага."); 
	What_Happened_2();
}
...
function What_Happened_2(){
	...
	n("И это только одна из трех дурацких вещей, которые произошли.");
	j("Никки...");
	...
	Choose({
		...
		"Нет, это моя вина.": function(message){
			...
			j("Ники, ты имел полное право доверять им, они твои родители. Однако, они злоупотребили этим доверием. Ты не виноват.");
			n("Да уж...");
			What_Now();
		}
	});
