...
function Start_Jack_1(){
	...
	j("Никки, тебе либо нужны субтитры, либо чаще чистить уши.");
	j("Как ты воспринимаешь концовку?");
...
function Thanks(){
	...
	j("Я бы хотел, чтобы ты не говорил родителям, что мы учились, когда на самом деле мы проводили время в кино.");
	n("Притворюсь, что мы будем зубрить конспекты всю ночь -- хах?");
...
function Hiding(){
	...
	if($.hippies){
		...
		n("Когда я у вас дома, я даже не уверен воздух задымлён ладаном или марихуаной.");
...
function Hiding_3(message){
	...
	n(message);
	j(". . .");
	n("Я не хочу слишком сильно их напугать.");
	n("Мне всё ещё нужно завтра вечером убедить их, чтобы остаться у тебя на ночь.");
	n("Скажу им, что снова буду учить с тобой уроки.");
	j(". . .");
	n("Уже обеденное время. Я сейчас планирую спуститься вниз.");

	j("Эй... Я согласен.");
	n("А?");
	j("Согласен с твоими мыслями о конце фильма.");
	switch($.inception_answer){
		case "dream": j("Я думаю, Кобб всё еще мечтал, живя во лжи."); break;
		case "awake": j("Я думаю, Кобб воссоединился со своей настоящей семьёй, в реальном мире."); break;
