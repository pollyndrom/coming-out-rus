...
function Start_Dinner_2(){
	...
	switch($.waiting_action){
		case "eat":
			...
			break;
		case "wait":
			m("Ты мог бы не ждать меня. Нет необходимости употреблять еду остывшей.");
			n("...конечно.");
			break;
		case "play":
	...
	m("Отец задерживается. Он присоединится к нам в течение часа.");
	...
	Choose({
		...
		"Мне есть, что сказать вам обоим.": function(message){
			n(message);
			m("Хорошо. Расскажешь позже, когда папа вернётся.");
			n("О-кей.");
			m(". . .");
			n("*ням ням ням*");
			m("Какие у тебя планы на завтра?");
		...
		"Мне нужно кое-что рассказать тебе.": function(message){
			n(message);
			m("Погоди Ник, я ещё не узнала как прошёл твой день!");
			n("Сегодняшний день был замечательным.");
			m("Ладно. А что ты планировал на завтра?");
			Start_Dinner_2_1();
		}
	});
...
function Start_Dinner_2_2(message){
	...
	n("На самом деле, я собираюсь учиться у Джека дома.");
	m("Снова?");
	...
	Choose({
		...
		"Мам, Джек для меня... больше чем друг.": function(message){
			...
			m("О, так вы лучшие друзья?");
			n("Ам. Ну--");
			m("Значит, ты просто тусуешься с ним, а не учишься.");
			n("Мы УЧИМСЯ!");
			m(". . .");
...
function Buddy_1(message){
	...
	if($.relationship!="study"){
		$.lying_about_hanging_out = true;
		m("Оу. Значит ты просто тусуешься с ним, а не учишься.");
		n("Мы УЧИМСЯ!");
		m(". . .");
		m("Ладно, просто не ври мне.");
		n("Я не вру.");
...
function Buddy_1_point_5(){
	...
	Choose({
		"Оу, нууу, мы всего лишь друзья.": function(message){
...
function Buddy_4(message){
	...
	Choose({
		"Ты думаешь, он гей?": function(message){
			n(message);
			m("Именно!");
			m("Ты тоже его в этом подозреваешь!");
			Buddy_Choice();
		},
...
function Buddy_Choice(){
	...
	Choose({
		"Он ведёт себя как гей. К счастью, это не так.": function(message){
			n(message);
			m("Видишь? Ты тоже подозревал неладное.");
			n("...конечно.");
			Buddy_Aftermath();
		},
...
function Buddy_Aftermath_2(message){
	...
	n("Как ты...");
	n("Уф, проехали.");
	m("Ник, прости, если я докучаю.");
	n("Нет, мама, просто хватит--");
	m("Вернёмся к разговору про твои отметки.");
	m("Напомни, какой предмет ты будешь учить завтра?");
...
function Grades_Start_2(){
	...
	if($.lying_about_hanging_out){
		m("Интересно, учишься ли ты с Джеком вообще или только развлекаешься.");
		n("Мы учимся.");
	}
	m(". . .");
